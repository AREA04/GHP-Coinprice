...
This minimum Coinprice template was developed by James Higginbotham and Hillary Fraley. For information about how to use the template, check out the [GHP-Coinprice repo README.md](https://github.com/launchany/GHP-Coinprice).
